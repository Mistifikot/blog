...
server.tool("get-game-details",
  { gameName: z.string() },
  async (params: { gameName: string }) => {
    try {
...
server.resource(
  "game",
  new ResourceTemplate("game://{gameName}/{filePath*}"),
  async (uri: URL, variables: any) => {
    try {
      const params = variables as { gameName: string; filePath?: string };
